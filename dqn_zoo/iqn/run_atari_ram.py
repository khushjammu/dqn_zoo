...
flags.DEFINE_integer('tau_latent_dim', 64, '')
flags.DEFINE_integer('tau_samples_policy', 64, '')
flags.DEFINE_integer('tau_samples_s_tm1', 64, '')
flags.DEFINE_integer('tau_samples_s_t', 64, '')


def main(argv):
  """Trains IQN agent on Atari ram-states."""
  del argv
  ...
  network_fn = networks.iqn_atari_network(num_actions, FLAGS.tau_latent_dim)
  ...
  assert sample_network_input.state.shape == (128, FLAGS.num_stacked_frames)
  ...
  train_agent = agent.Iqn(
      ...
      tau_samples_s_tm1=FLAGS.tau_samples_s_tm1,
      tau_samples_s_t=FLAGS.tau_samples_s_t,
